...
<head>
	...
	<meta name="p:domain_verify" content="a26ba1607823c9b963f408822c149185"/>
    ...
    <link href="/new/style.css?v=1" rel="stylesheet
	...
	<link href="/new/styles.css?v=1" rel="stylesheet">
...
<script>
  ...
  function ready() {
	...
	$('img[data-width]').each(function(index) {
		...
		$(this).closest('.room-slider-holder').addClass('load');
...
$(".thumb").hover(
  function() {
	...
	<link href="/new/styles_rooms.css" rel="stylesheet">
...
<link href="/new/slider/slick.css" rel="stylesheet">	

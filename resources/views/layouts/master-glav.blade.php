...
<head>
	...
	<meta name="google-site-verification" content="ozQeiRw9IA-bW0DIpzUWZqzMqnNsHe9yt4fXlQwCeSU" />
...
window.addEventListener("load", function(event) {
	...
	<link href="/new/styles_glav.css" rel="stylesheet">
	...
	<link href="/new/project.css" rel="stylesheet">
...
-->
                        ...
                        <div class="col-md-3 col-xs-4 xs-nopadding">
                            ...
                            <button class="dropdown-toggle c_clear_btn" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                ...
                                <ul style="right:-50px;left:auto;" class="dropdown-menu" aria-labelledby="dropdownMenu1">
...
@foreach(App\Models\Country::all() as $country)
	...
	@if( null != session('city_id') && session('city_id') == $city->id) 
		<?php $test = 1; ?>
		{{ $city->name }}
	@endif
...
<link href="/new/slider/slider.css" rel="stylesheet">
	
@yield('script')
	<script src="/js/rotator.js"></script>
	
	<script src="/new/slider/slider.js"></script>

...
$(".thumb").hover(
  function() {
    ...
    <style>
		...
		header #main-menu > li { padding: 0 0 35px; z-index: 10; }
		header #main-menu > li.dropdown ul.dropdown-menu { margin-top: 0; }
		header #main-menu .dropdown div.dropdown-menu { opacity: 0; transition: .5s; }
		header #main-menu .dropdown:hover div.dropdown-menu { opacity: 1; transition: .5s; }
		header #main-menu div.dropdown-menu ul { float: left; width: 33.333%; }
		header #main-menu div.dropdown-menu a { font-size: 12px; }
		header #main-menu div.dropdown-menu li { height: 25px; }
		
		.hr-link { padding: 8px 40px!important; }
		hr { margin-top: 17px; margin-bottom: 18px; }
...
">
                                   <div class="col-md-12">
                                   <div class="col-md-4">
								   <div id="thumb" style="background:url(https://roomlook.com/images/rooms/md/1536220673.jpg) center center no-repeat;width:100%;height:200px;"> 
								   </div>
								   </div>
                                   <div class="col-md-8">
                                <h4 class="gray">Стиль</h4>
                                <ul>
                                ...
                                <ul>
									...
									<li ><a class="thumb" data-img="https://roomlook.com/images/rooms/md/1536214724.jpg" href="/ru/projects?room_style_id=13">Прованс </a></li>
									<li ><a class="thumb" data-img="https://roomlook.com/images/rooms/md/1528098222.jpg" href="/ru/projects?room_style_id=14">Восточный </a></li>
                                </ul>
                                <ul>
									...
									<li ><a class="thumb" data-img="https://roomlook.com/images/rooms/md/1539675908.jpg" href="/ru/projects?room_style_id=16">Винтаж</a></li>

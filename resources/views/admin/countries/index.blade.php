  ...
  <div class="panel panel-default">
	<div class="panel-heading">
		...
		<div class="panel-nav pull-right" style="margin-top: -7px;">
			<a href="{!! route('admin.countries.create') !!}" class="btn btn-default">Add New</a>
		</div>
		<div></div>
				...
				<tr>
					...
					<td class="text-center">
						<div class="btn-group">
							...
							<a href="{!! route('admin.countries.show', $country->id) !!}" class="btn btn-sm btn-default" title="View" data-toggle="tooltip"><i class="glyphicon glyphicon-eye-open"></i></a>
							<a href="{!! route('admin.countries.edit', $country->id) !!}" class="btn btn-sm btn-default" title="Edit" data-toggle="tooltip"><i class="glyphicon glyphicon-edit"></i></a>

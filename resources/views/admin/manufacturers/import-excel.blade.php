...
<div class="form-horizontal">
    @if (isset($model))
        {!! Form::model($model, ['files' => true, 'method' => 'POST', 'route' => ['admin.manufacturers.import-excel', $model->id]]) !!}
    @else
        {!! Form::open(['files' => true,'method' => 'POST',  'route' => 'admin.manufacturers.import-excel']) !!}
    @endif

...
<style>
    ...
    <section id="main" style="background:none;">
        <div id="content" style="padding:0;">
            <div class="container padding-top-20">
                <div class="rooms homepage-rooms " data-count-item="1">
                    <div class="row">
                        <h1 class="margin-left-10">{{ trans('frontend.common.new-projects') }}</h1>   
                        @foreach ($projects as $key => $project)
                        @if ($project->order_in_main == 3)
                            <div data-aos="zoom-in-up" class="big-project project-block col-md-12 padding-7px pqrw" data-room-id="{{ $project->rooms()->first()->id }}">
                        ...
                        @else
                            <div data-aos="zoom-in-up" class="project-block col-md-4 padding-7px" data-room-id="{{ $project->rooms()->first()->id }}" style="
                            padding-bottom: 35px;
                            @if ($key == 1)
                            padding-right: 10px;
                            padding-left: 0px;
                            ...
                            @endif
                            ">
                                <div data-aos="zoom-in-up" style="background:white;padding:20px;" class="small-project tempcl">
                                ...
                                @for ($j = 0; $j < 3; $j++)
                                    @foreach ($ideas as $idea)
                                        ...
                                        <td colspan="{{ $sizes[0] }}" 
                                            ...
                                            @else
                                            <div style="height:100%;">
                                                <div data-aos="zoom-in-up" class="small-project idea-item {{ 's'.$idea->size }}" style="padding: 50px!important;">
    ...
    margin: 5px 0;">
            ...
            <div class="container padding-top-20 mn">
                <div class="">
                    <div class="row" style="margin-left: -12px;">
                        ...
                        <div class="sel-fur-bg" style="padding-bottom:35px;">
            ...
            <div class="container padding-top-20">
                <div class="">
                    <div class="roomtype-categories" style="margin: 0 -10px;">
                        <div class="row">
                                    ...
                                    <div class="col-xs-12 {!! $pcategory->classes !!} category-item" style="{!! $pcategory->styles !!}">
                                        <a href="/{{ LaravelLocalization::getCurrentLocale() }}/room?room_type_id={{ $pcategory->id }}">
                                            <div class="category-holder" style="height: 100%;">
                                                <a href="/{{ LaravelLocalization::getCurrentLocale() }}/room?room_type_id={{ $pcategory->id }}"><div class="small-project no-grad category-image" style="background-image: url(/{{ $pcategory->imagePath() }}); height: 100%;
    background-size: 100%;
    ...
    margin-top: 25px;
    margin-bottom: 35px;
    font-size: 15px;">Эта светлая студия в Москве, оформленная Марией Дадиани, - практически наглядное пособие по тому, как сделать интерьер маленькой однушки уютным, нескучным и изысканным. Хозяин этой небольшой квартиры оказался противником типичных мужских интерьеров: тёмным цветам и брутальным фактурам он предпочёл свет, разумную планировку и яркие акценты. Ситуацию осложнял размер однокомнатной квартиры, но дизайнер Мария Безрукова нашла способ превратить её в комфортную. </p>
                                <div class="col-md-3 col-md-offset-1"><hr style="border-top: 1px solid black;"></div>
            ...
            <div class="container padding-top-20">
                <div class="">
                    <div class="row roomtype-categories" style="padding: 0 15px;">
                        <div class="row" style="padding: 20px 20px 35px;background: white;">
						<h1 style="margin-top: 10px; margin-bottom: 10px; margin-left: 12px;" class="margin-left-10">{{ trans('frontend.common.rooms') }}</h1>
                            ...
                            @endif
                                <a href="/{{ LaravelLocalization::getCurrentLocale() }}/room?room_type_id={{ $pcategory->id }}">
                                    <div class="category-holder" style="height: 100%; {!! ($key == 2) ? 'margin-top: 15px' : '' !!}">
                                        <a href="/{{ LaravelLocalization::getCurrentLocale() }}/room?room_type_id={{ $pcategory->id }}"><div class="small-project grad category-image" style="background-image: url(/{{ $pcategory->imagePath() }}); height: 100%;">
                                            
                                        </div></a>
                                        <div class="category-nav">
                                            <a href="/{{ LaravelLocalization::getCurrentLocale() }}/room?room_type_id={{ $pcategory->id }}" class="category-name link-hover" style="
    border: 2px solid;

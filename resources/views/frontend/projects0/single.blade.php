...
@section('content')
    ...
    <section id="main" class="rooms-page">
        ...
        <div class="container single-project">
            <!-- <a class="backbtn c_btn_transparent_green c_btn_small " href="javascript:history.back()">Назад</a> -->
            <div class="catalog">
                <div class="catalog-header row">
                    <div class="col-md-12">
                        <h2 class="single-project-title">{{ $project->name }}</h2>
                ...
                <div class="catalog-body list-group  rooms " data-count-item="1">
                    ...
                    <div class="catalog-body list-group  rooms " data-count-item="1">
                        ...
                        <div class="gridview">
                            <?php $i = 0; ?>
                            @foreach ($project->rooms()->orderBy('position')->get() as $room)
            ...
            <div class="row" >
                <div class="col-md-12">
                    <h5 class="text-uppercase">{{ trans('frontend.common.similar-projects') }}</h5>
                    <div class="row">

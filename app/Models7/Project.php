...
{   
    ...
    public $translatedAttributes = ['name', 'description', 'short_desc', 'seo_keywords', 'slug'];
    protected $fillable = ['name', 'author_id','slug', 'description', 'square', 'designer_id','photograph_id', 'short_desc', 'is_home_slider', 'seo_keywords', 'seo_description', 'is_new', 'order', 'project_relations_id', 'order_in_main'];

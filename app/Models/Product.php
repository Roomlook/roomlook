...
class Product extends Model {
	...
	use Translatable;
    protected $table = 'products777';
    public $translationModel = 'App\Models\ProductTranslation';
    public $translatedAttributes = ['name', 'short_body','slug'];
    protected $fillable = ['name','room_type_id','short_body','slug','is_wide', 'manufacturer_id','image','pcategory_id','relative_id'];
    ...
    public function category_product() {
        return $this->belongsToMany('App\Models\PcategoriesProducts','pcategories_products');
    }
    public function room_product() {
        return $this->belongsToMany('App\Models\ProductRoom','product_room');
    }
    public function tag_product() {
        return $this->belongsToMany('App\Models\TagsProducts','product_tags');
    }
	/**/
    ...
    public function oneTags() { 
        //return $this->belongsTo('App\Models\TagTranslation');        
    }
    ...
    {
        return Product::leftJoin('product_translations', 'products777.id', '=', 'product_translations.product_id')
